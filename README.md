...
Android 调试版（v1.3.0，包含记忆、关系与界面更新）：[下载 APK](https://github.com/naitjc/chat/releases/download/v1.3.0/Chat-RP-v1.3.0.apk)
...
该 APK 使用开发调试签名，适合直接安装测试；正式分发时应改用自己的 release keystore 签名。当前 Android 版本号为 `1.3.0`（versionCode `6`）。
